...
export const View = (player, KitName, status) => {
    ...
    const ViewForm = new ActionFormData()
        .title(KitName)
        .body(status !== null && status !== void 0 ? status : translate('viewDefaultStatusMsg', [KitName, KitData === null || KitData === void 0 ? void 0 : KitData.description, String(KitData === null || KitData === void 0 ? void 0 : KitData.onlyOnce), KitData === null || KitData === void 0 ? void 0 : KitData.requiredTag, MS(KitData === null || KitData === void 0 ? void 0 : KitData.cooldown), String(KitData === null || KitData === void 0 ? void 0 : KitData.itemCount), KitData === null || KitData === void 0 ? void 0 : KitData.createdAt]))
